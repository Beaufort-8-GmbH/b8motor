...
class StrCountViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper
{
    public function initializeArguments()
    {
        $this->registerArgument('v1', 'string', 'The input value. If not given, the evaluated child nodes will be used.', true, null);
        $this->registerArgument('v2', 'string', 'The input value. If not given, the evaluated child nodes will be used.', true, null);
    }

    public function render(): int
    {
        $a = (string)$this->arguments['v1'];
        $b = (string)$this->arguments['v2'];
