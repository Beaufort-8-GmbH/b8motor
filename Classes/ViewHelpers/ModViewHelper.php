...
class ModViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper
{
    public function initializeArguments()
    {
        $this->registerArgument('v1', 'string', 'The input value. If not given, the evaluated child nodes will be used.', true, null);
        $this->registerArgument('v2', 'string', 'The case to apply, must be one of this\' CASE_* constants. Defaults to uppercase application.', true, null);
    }

    public function render(): int
    {
        $a = (int)$this->arguments['v1'];
        $b = (int)$this->arguments['v2'];
